...
<body id="page-top">
  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <!-- Nav Item - Tables -->
      <li class="nav-item">
        <a class="nav-link" href="<?php echo base_url('Books') ?>">
          <i class="fas fa-fw fa-book-open"></i>
          <span>Books</span></a>
      </li>
      <!-- Nav Item - Tables -->
      <li class="nav-item">
        <a class="nav-link" href="<?php echo base_url('BookCategories') ?>">
          <i class="fas fa-fw fa-bookmark"></i>
          <span>Book Categories</span></a>
      </li>
      <!-- Nav Item - Tables -->
      <li class="nav-item">
        <a class="nav-link" href="<?php echo base_url('BookGenres') ?>">
          <i class="fas fa-fw fa-bible"></i>
          <span>Book Genres</span></a>
      </li>
      <!-- Nav Item - Tables -->
      <li class="nav-item">
        <a class="nav-link" href="<?php echo base_url('BookLanguages') ?>">
          <i class="fas fa-fw fa-language"></i>
          <span>Book Languages</span></a>
      </li>
              ...
              <div class="card shadow mb-4">
                ...
                <div class="card-body">
                  ...
                  <!-- <div class="mt-4 text-center small">
                    ...
                    <span class="mr-2">
                      <i class="fas fa-circle text-danger"></i> D
                    </span>
                  </div> -->
                </div>
              </div>
 ...
 <!--  <a class="scroll-to-top rounded" href="#page-top">
  ...
  <script type="text/javascript">
    var graphopt = [];
    for(i=0;i<=11;i++){
      graphopt[i] = Math.floor(Math.random()*10000);
    }
  ...
  <script type="text/javascript">
    ...
    var Apie = Math.ceil(Math.random()*10000);
    var Bpie = Math.ceil(Math.random()*10000);
    var Cpie = Math.ceil(Math.random()*10000);
    var Dpie = Math.ceil(Math.random()*10000);

    var Apipercent = Math.round((Apie/(Apie+Bpie+Cpie+Dpie))*100);
    var Bpipercent = Math.round((Bpie/(Apie+Bpie+Cpie+Dpie))*100);
    var Cpipercent = Math.round((Cpie/(Apie+Bpie+Cpie+Dpie))*100);
    var Dpipercent = Math.round((Dpie/(Apie+Bpie+Cpie+Dpie))*100);
    ...
    var myPieChart = new Chart(ctx, {
      ...
      data: {
        labels: ["A", "B", "C", "D"],
        datasets: [{
          data: [Apipercent, Bpipercent, Cpipercent, Dpipercent],
          backgroundColor: ['#4e73df', '#1cc88a', '#36b9cc', '#76b9cc'],
          hoverBackgroundColor: ['#2e59d9', '#17a673', '#449faf', '#5c9faf'],
